...
- **Draw**: `FA.draw.clear/rect/text/bar/circle/sprite/pushAlpha/popAlpha/withAlpha` — **Use `pushAlpha(alpha)`/`popAlpha()` instead of `withAlpha` in loops** (avoids closure allocation per iteration)
